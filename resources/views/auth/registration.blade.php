...
<div class="form-group mb-3">
<input type="text" placeholder="Union" id="uPorisod" class="form-control"
name="uPorisod" required>
@if ($errors->has('uPorisod'))
<span class="text-danger">{{ $errors->first('uPorisod') }}</span>
@endif
</div>
<div class="form-group mb-3">
<div class="checkbox">
